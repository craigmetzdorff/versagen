...
{
    public class VersaHastyImplementationExtra
    {
        ...
        class PostEventResponder:IEventObserver
        {
            ...
            {
                OnNextAsync(value, ExecuteStage);
            }
            ...
            public EEventObserverExecStage ExecuteStage { get; set; } = EEventObserverExecStage.AfterCommand;
            public Task OnNextAsync(IEvent next, EEventObserverExecStage execStage = default)
            {
                Console.WriteLine("A command has been run.");
        ...
        public interface IInjectedTester
            ...
            bool didDebug = false;
        private readonly EventQueue<CommandManager<CommandContext>, VersaCommand, CommandContext, CommandContext.Builder> EQ;

        public readonly Versagen.Events.EventWaiter<CommandManager<CommandContext>, VersaCommand, CommandContext, CommandContext.Builder> Waiter;

        public readonly Versagen.Events.TaskEventRunner<CommandManager<CommandContext>, VersaCommand, CommandContext, CommandContext.Builder> Runner;

        const int CountTestTestAgainst = 3;

        public Task<bool> AddEvent(IEvent e)
            =>
                EQ.AddEvent(e);

            public VersaHastyImplementationExtra()
            {
            ...
            Waiter =
                new EventWaiter<CommandManager<CommandContext>, VersaCommand, CommandContext, CommandContext.Builder>(EQ);
            Runner =
                new TaskEventRunner<CommandManager<CommandContext>, VersaCommand, CommandContext, CommandContext.Builder>(Waiter, EQ);

            EQ.Subscribe(new PostEventResponder());
